<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="serverzl_1.aspx.cs" Inherits="wxtest.UILayer.FastClaimsPages.starservicePages.serverzl_1" %>
...
<body>
    ...
    <div data-role="page" class="ui-page-theme-a">
        ...
        <div role="main" class="ui-content">
            <img style="width: 100%" src="/assets/images/web/serverzhaolu.jpg" alt="" height="200" />
            <hr />
            <p>
                <strong><span style="font-size: 18px; color: #FF9900;">赵露<br />
            ...
            <p>
                <strong><span style="color: #999999; font-size: 14px;">熟悉掌握快出快赔中心事故处理流程，并精通各保险公司理赔政策，随时给您提供理赔及咨询服务。</span></strong><br />
            </p>
            <form action="serverzl_1.aspx" method="post">
                <section>
                    <h2>评价信息</h2>
