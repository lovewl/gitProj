<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="serverjyr_1.aspx.cs" Inherits="wxtest.UILayer.FastClaimsPages.starservicePages.serverjyr_1" %>
...
<body>
    ...
    <div data-role="page" class="ui-page-theme-a">
        ...
        <div role="main" class="ui-content">
            <a href="http://mp.weixin.qq.com/s?__biz=MzAwMzAwMjAzNQ==&mid=203826051&idx=1&sn=c6f5e3a3232416616c2105ae5ab42d8a#rd">
                <img style="width: 100%" src="/assets/images/web/serverjingyaru.jpg" alt="" height="200" /></a>
            <hr />
            <p>
                <strong><span style="font-size: 18px; color: #FF9900;">景亚茹<br />
            ...
            <p>
                <strong><span style="font-size: 14px; color: #999999;">您如果在行驶途中发生轻微交通事故，不知如何处理时，请拨打我的电话：<br />
                    <a style="text-decoration:none" href="tel:18066628336"><span style="font-size: 18px;">18066628336</span></a><br />
                    我是快赔专员，景亚茹。服务于快速理赔中心已有6年。熟悉快赔和各大保险公司上的理赔政策，能够第一时间给您快速.便捷的处理方式。<br />
                    性格开朗，服务热情，以诚相待。如有需要，欢迎您的来电！</span></strong><br />
            </p>
            <form action="serverjyr_1.aspx" method="post">
                <section>
                    <h2>评价信息</h2>
