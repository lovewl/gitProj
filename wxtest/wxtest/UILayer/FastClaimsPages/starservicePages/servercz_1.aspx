<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="servercz_1.aspx.cs" Inherits="wxtest.UILayer.FastClaimsPages.starservicePages.servercz_1" %>
...
<body style="padding-top: 0; padding-bottom: 50px;">
    ...
    <div class="RoundedCorner">
        ...
        <div class="divall">
            <div class="divimg">
                <a href="/UILayer/FastClaimsPages/starservicePages/servercz_1.aspx">
                    <img src="/images/web/serverchenzhen.jpg" alt="" height="200" /></a>
            </div>
            <hr style="color: red;">
            <div class="divtitle">
                <span class="titlespan">陈珍<br />
                    服务专员等级：<span data-score="<%=DisplayStarts %>" data-number="5" id="raty"></span>(<%=DisplayStarts %> 分,满分5分)</span><span class="titlestarspan">
                        <%--<img src='/images/web/star.gif' width='15' height='20' style='margin-top: 0px;' />
                    <img src='/images/web/star.gif' width='15' height='20' style='margin-top: 0px;' />
                    <img src='/images/web/star.gif' width='15' height='20' style='margin-top: 0px;' />
                    <img src='/images/web/star.gif' width='15' height='20' style='margin-top: 0px;' />
                    <img src='/images/web/star.gif' width='15' height='20' style='margin-top: 0px;' />--%>
            ...
            <div class="divtime">
                <span runat="server" class="timespan"><%= DateStr %></span>
                <!--
            ...
            <div class="divcontent">
                <p style="font-family: sans-serif; font-size: 16px;">
                    <strong><span style="font-family: 宋体;"><strong></strong></span></strong>
                </p>
                <p style="font-family: sans-serif; font-size: 16px;">
                    <strong><strong><strong><span style="color: #000000; font-size: 24px;">您如果在行驶途中发生轻微交通事故，不知如何处理时，请拨打我的</span></strong><strong><span style="color: #000000; font-size: 24px;">电话：</span></strong> </strong></strong>
                </p>
                <strong><span style="color: #0070C0; font-family: Tahoma, sans-serif; text-decoration: underline;"></span></strong><span style="color: #0070C0; font-size: 18px;"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 24px;"><a href="tel:15353626787">15353626787</a></span><img alt="" src="/images/web/30.gif" border="0" /></span></strong></span><strong><span style="color: #0070C0; font-family: 宋体; font-size: 18px; text-decoration: underline;"></span></strong>
                <p>
                    <strong><span style="color: #000000; font-family: 宋体; font-size: 24px;">我是快赔专员，陈珍。本人从事保险理赔行业3年，能够熟练办理各个保险公司汽车理赔业务。工作认真负责，待人热情主动。</span></strong>
                </p>
            </div>
