<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consultantsuping_1.aspx.cs" Inherits="wxtest.UILayer.shanxiyongjiuPages.consultantPages.consultantsuping_1" %>
...
<body>
    ...
    <div data-role="page" class="ui-page-theme-a">
        ...
        <div role="main" class="ui-content">
            <img style="width: 100%" src="/assets/images/web/serversuping.jpg" alt="" height="200" />
            <hr />
            <p>
                <strong><span style="font-size: 18px; color: #FF9900;">苏萍<br />
            ...
            <p>
                <strong><span style="font-size: 14px; color: #999999;">从事汽车服务行业五年，大专学历，对待客户和同事热情主动，对待工作任劳任怨。</span></strong><br />
                <br />
                <strong><span style="font-size: 14px;"><span style="color: #999999;">联系电话：</span><a style="text-decoration:none" href="tel:02963621305" target="_blank"><span style="font-size: 18px; color: #337FE5;">029-63621305</span></a></span></strong><br />
            </p>
            <form action="consultantsuping_1.aspx" method="post">
                <section>
                    <h2>评价信息</h2>
