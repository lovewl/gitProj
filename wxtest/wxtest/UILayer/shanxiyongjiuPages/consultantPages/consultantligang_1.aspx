<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consultantligang_1.aspx.cs" Inherits="wxtest.UILayer.shanxiyongjiuPages.consultantPages.consultantligang_1" %>
...
<body>
    ...
    <div data-role="page" class="ui-page-theme-a">
        ...
        <div role="main" class="ui-content">
            <img style="width: 100%" src="/assets/images/web/serverligang.jpg" alt="" height="200" />
            <hr />
            <p>
                <strong><span style="font-size: 18px; color: #FF9900;">李刚<br />
            ...
            <p>
                <strong><span style="font-size: 14px; color: #999999;">从事汽车行业10年，主要接待大事故车辆维修，工作认真，责任心强！</span></strong><br />
                <br />
                <strong><span style="font-size: 14px; color: #999999;">联系电话：<a style="text-decoration:none" href="tel:02963621307" target="_blank"><span style="font-size: 18px; color: #337FE5;">029-63621307</span></a></span></strong><br />
            </p>
            <form action="consultantligang_1.aspx" method="post">
                <section>
                    <h2>评价信息</h2>
