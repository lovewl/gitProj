<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wifipage.aspx.cs" Inherits="wxtest.UILayer.shanxiyongjiuPages.wifipage" %>
...
<body>
    ...
    <div data-role="page" class="ui-page-theme-a">
        ...
        <div role="main" class="ui-content">
            <img style="width: 100%" src="/assets/images/web/yongjiu05.jpg" alt="" height="200" />
            <hr />
            <p>
                <strong><span style="font-size: 18px; color: #FF9900;">WIFI上网</span><br />
            ...
            <p>
                <span style="font-size: 14px; color: #999999;"><strong>快速理赔大厅：“快速理赔-扫二维码免费上网”</strong></span><br />
                <br />
                <span style="font-size: 14px; color: #999999;"><strong>密码：yongjiu11</strong></span><br />
                <br />
                <span style="font-size: 14px; color: #999999;"><strong>------------------------------------</strong></span><br />
                <br />
                <span style="font-size: 14px; color: #999999;"><strong>客户休息室：“yongjiu-guest”</strong></span><br />
                <br />
                <span style="font-size: 14px; color: #999999;"><strong>密码：12345678</strong></span><span style="font-size: 14px; color: #999999;"><strong></strong></span><br />
            </p>
            <hr />
