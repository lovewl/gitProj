<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderList.aspx.cs" Inherits="wxtest.UILayer.MetalPlate.orderList" %>
...
<body>
    ...
    <div data-role="page" class="ui-page-theme-a">
        ...
        <div role="main" class="ui-content">
            <div>
                <asp:Repeater ID="rptSprayOrder" runat="server">
                    <ItemTemplate>
                        <section>
                            <span style="color: red"><%# Eval("Name") %></span>
                            <span style="color: green"><%# Eval("Mobile") %></span>
                            <span style="color: blue"><%# Eval("ModelName") %></span>
                            <span style="color: orange"><%# Eval("OrderContent") %></span>
                            <span style="color: purple"><%# Eval("CreateTime") %></span>
                            <span style="color: steelblue; font-weight: 900">总价：<%# Eval("PriceSum") %></span>
                        </section>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
