<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="success.aspx.cs" Inherits="wxtest.UILayer.Shop.template.success" %>
    ...
    <div data-role="page" class="ui-page-theme-a">
        ...
        <div role="main" class="ui-content">
            <div class="main">
                <h1>订购成功!</h1>
                <p>感谢您的订购，请尽快到店确认</p>
                <p><a class="ui-btn ui-btn-corner-all" href="/UILayer/Shop/index.aspx" role="button" style="width: 45%">返回商城首页</a></p>
            </div>
        </div>
