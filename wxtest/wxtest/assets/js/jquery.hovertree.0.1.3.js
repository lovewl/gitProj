...
(function ($) {
    $.fn.hovertree = function (options) {
        ...
        , function () {
            ...
            , "border": "solid 1px #ccc", "z-index": "2014", "display": "none"
            });

            switch (k_subMenuShowWay) {
                case "show":
                    submenu.show(settings.subMenuShowSpeed);
                    break;
                case "fadein":
                    submenu.fadeIn(settings.subMenuShowSpeed);
                    break;
                case "slidedown":
                    submenu.slideDown(settings.subMenuShowSpeed);
                    break;
            }
