    ...
    public partial class upload : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                original_image.Save(Server.MapPath("/images/" + "temp.jpg"), System.Drawing.Imaging.ImageFormat.Jpeg);
                var md5str = MD5Helper.GetMD5Str(Server.MapPath("/images/" + "temp.jpg"));
                original_image.Save(Server.MapPath("/images/" + md5str + ".jpg"), System.Drawing.Imaging.ImageFormat.Jpeg);
                File.Delete(Server.MapPath("/images/" + "temp.jpg"));
                ...
                final_image.Save(Server.MapPath("/images/thumbnail/" + "temp.jpg"), System.Drawing.Imaging.ImageFormat.Jpeg);
                md5str = MD5Helper.GetMD5Str(Server.MapPath("/images/thumbnail/" + "temp.jpg"));
                final_image.Save(Server.MapPath("/images/thumbnail/" + md5str + ".jpg"), System.Drawing.Imaging.ImageFormat.Jpeg);
                File.Delete(Server.MapPath("/images/thumbnail/" + "temp.jpg"));
