...
namespace WxDev.BLL
{
    public class AccessTokenInfo
    {
        ...
        /// 数据库操作对象
        /// </summary>
        private AccessTokenDAO _dao = new AccessTokenDAO();
        ...
        #region 根据主键ID更新一条记录 +int Update(Access_Token model)
        /// <summary>
        /// 根据主键ID更新一条记录
        /// </summary>
        ...
        #region 分页查询一个集合 +IEnumerable<Access_Token> QueryList(int index, int size, object wheres, string orderField, bool isDesc = true)
        /// <summary>
        /// 分页查询一个集合
        /// </summary>
        ...
        #region 查询单个模型实体 +Access_Token QuerySingle(object wheres)
        /// <summary>
        /// 查询单个模型实体
        /// </summary>
        /// <param name="wheres">条件匿名类</param>
